...
export default {
  ...
  createBatchObat(obatList) {
    return API.post(`${baseURL}/obat/batch`, obatList, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    });
  ...
  updateBatchObat(obatList) {
    return API.put(`${baseURL}/obat/batch_update`, obatList);
  },
  deleteObat(id) {
  ...
  updateTransaksi(id, transaksi) {
    return API.put(`${baseURL}/transaksi/${id}`, transaksi);
  },
  updateStatusTransaksi(id, transaksi) {
    return API.put(`${baseURL}/transaksistatus/${id}`, transaksi, {
      headers: {
        "Content-Type": "multipart/form-data",
      },
    });
  ...
  createBatchTransaksi(transaksiList) {
    return API.post(`${baseURL}/transaksi/batch_create`, transaksiList);
  },
  updateBatchTransaksi(transaksiList) {
    return API.put(`${baseURL}/transaksi/batch_update`, transaksiList);
  },
  deleteBatchTransaksi(ids) {
    return API.post(`${baseURL}/transaksi/batch_delete`, ids);
  },
  ...
  updateTipeObat(id, tipeObat) {
    return API.put(`${baseURL}/tipe_obat/${id}`, tipeObat);
  },
  deleteTipeObat(id) {
    return API.delete(`${baseURL}/tipe_obat/${id}`);
  },
  createBatchTipeObat(tipeObatList) {
    return API.post(`${baseURL}/tipe_obat/batch_create`, tipeObatList);
  },
  updateBatchTipeObat(tipeObatList) {
    return API.put(`${baseURL}/tipe_obat/batch_update`, tipeObatList);
  },
  deleteBatchTipeObat(ids) {
    return API.post(`${baseURL}/tipe_obat/batch_delete`, ids);
  },
  getLaporanTransaksi() {
    return API.get(`${baseURL}/laporan/laporan-transaksi`);
  },
  getLaporanStok() {
    return API.get(`${baseURL}/laporan/laporan-stok`);
  },
  getLaporanLaba() {
    return API.get(`${baseURL}/laporan/laporan-labarugi`);
  },

  getAllPemasok() {
    return API.get(`${baseURL}/pemasok`);
  },
  CreatePemasok(pemasok) {
    return API.post(`${baseURL}/pemasok`, pemasok);
  },
  UpdatePemasok(id, pemasok) {
    return API.put(`${baseURL}/pemasok/${id}`, pemasok);
  },
  deletePemasok(id) {
    return API.delete(`${baseURL}/pemasok/${id}`);
  },
  ...
  GetGambarObatKatalog(namaobat) {
    console.log(namaobat);
    return API.get(`${baseURL}/obat/cari-gambar/${namaobat}`);
  },
  getFullImgPathObat(img) {
    return `https://katalog.inaproc.id/_next/image?url=${img}&w=384&q=75`;
  },
};
